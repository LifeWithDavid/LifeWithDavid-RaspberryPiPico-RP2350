...
// This code explores converting a number from memory and turing it into "lights" 3/6/25
...
#warning i2c / SSD1306_i2d example requires a board with I2C pins
	...
	char float_str[16];
	int *p_num = (int*)0x20030000; //This is the beginning of the emulator 6502 graphics memory
	// set up character array
	char *pc_disp = malloc(16);  //allocate 17 bytes for character array (16 for word and one for end byte)
...
restart:
	...
	*p_num = num; //This deposits the number "num" into address 0x20030000
	num2 = *p_num; //This reads the value located at pointer
	...
	sprintf(str, "M:%04X Num:%04X", num2,num); //convert num to hex format (capitalized)
